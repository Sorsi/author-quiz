  ...
  return (<div id="footer" className="row">
    <div className="col-12">
      <p className="text-muted credit">
        All images are from <a href="http://commons.wikipedia.org/wiki/Main_Page" target="blank">Wikipedia Commons</a> and are in the public domain
      </p>
    </div>
  </div>
  );
